const questions = [
  {
    id: '1',
    question:
      'Em uma reação o ferro reage com oxigênio para produzir óxido de ferro (II). Calcule a massa deste produto formada na reação de 112 g de ferro com 32 g de oxigênio.',
    image: '',
    options: [
  ...
  },
  {
    id: '2',
    question:
      'No processo de eletrólise da água formam-se gás hidrogênio e gás oxigênio. Recordando a Lei de Conservação de Massas de Lavoisier. Determine a massa de oxigênio formada.',
  ...
  },
  {
    id: '3',
    question:
      'Na combustão completa do metano são gerados gás carbônico e água. A tabela abaixo mostra resultados de dois experimentos. Recordando as Leis de Lavoisier e de Proust (Proporções fixas), calcule os valores faltantes.',
  ...
  },
  {
    id: '4',
    question:
      'Cálcio reage com oxigênio para formar óxido de cálcio. Aplicando as leis de Lavoisier e de Proust, preencha a tabela abaixo para os resultados de dois experimentos. ',
  ...
  },
  {
    id: '5',
    question:
      'Carbonato de cálcio quando aquecido se decompõe formando gás carbônico e óxido de cálcio. A decomposição completa de 10 g de cabonato de cálcio produziu 4,4 g de gás carbônico. Determine a massa de óxido de cálcio formada nesta reação.',
    image: '',
    options: [
  ...
  },
  {
    id: '7',
    question:
      'O gás nitrogênio reage com gás hidrogênio para formar amônia. Observe os dados experimentais abaixo e determine os valores de a, b, c, d e e.',
    image: './public/images/fig7.png',
    options: [
      {
        isCorrect: true,
        answer: 'a = 68 g, b = 30 g, c = 140 g, d = 504 g, e = 612 g',
      },
      {
        isCorrect: false,
        answer: 'a = 50 g, b = 250 g, c = 130 g, d = 500 g, e = 300 g',
      },
      {
        isCorrect: false,
        answer: 'a = 68 g, b = 30 g, c = 140 g, d = 500 g, e = 600 g',
      },
      {
        isCorrect: false,
        answer: 'a = 88 g, b = 40 g, c = 140 g, d = 504 g, e = 612 g',
      },
    ],
  },
  {
  ...
  },
  {
    id: '9',
    question:
      'O gás hidrogênio reage com o gás oxigênio para formar água. Determine os dados faltantes.',
    image: './public/images/fig9.png',
    options: [
      {
        isCorrect: true,
        answer:
          'Exp1. 18 g --- Exp2. 128 g --- Exp3. 25 g --- Exp4. 32 g e 36 g',
      },
      {
        isCorrect: false,
        answer:
          'Exp1. 16 g --- Exp2. 125 g --- Exp3. 25 g --- Exp4. 32 g e 36 g',
      },
      {
        isCorrect: false,
        answer:
          'Exp1. 18 g --- Exp2. 128 g --- Exp3. 50 g --- Exp4. 34 g e 38 g',
      },
      {
        isCorrect: false,
        answer:
          'Exp1. 36 g --- Exp2. 224 g --- Exp3. 25 g --- Exp4. 32 g e 36 g',
      },
    ],
  },
  {
    id: '10',
    question:
      'Numa reação, 24 g de magnésio reagem com uma certa massa de oxigênio formando 40 g de óxido de magnésio. a) Nesta reação que massa de oxigênio, em gramas, participa da reação? b) Em em experimento, que massa de magnésio reagiria com 20 g de oxigênio?',
    image: '',
    options: [
      {
        isCorrect: true,
        answer: 'a) 16 g de oxigênio; b) 30 g de magnésio',
      },
      {
        isCorrect: false,
        answer: 'a) 16 g de oxigênio; b) 20 g de magnésio',
      },
      {
        isCorrect: false,
        answer: 'a) 32 g de oxigênio; b) 20 g de magnésio',
      },
      {
        isCorrect: false,
        answer: 'a) 40 g de oxigênio; b) 30 g de magnésio',
      },
    ],
  },
  {
